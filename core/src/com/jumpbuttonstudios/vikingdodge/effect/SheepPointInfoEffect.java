...
public class SheepPointInfoEffect extends Effect {
	
	Sheep owner;

	public SheepPointInfoEffect(EntityHandler entityHandler, Sheep owner, Vector2 pos) {
		super(entityHandler, pos);
		this.owner = owner;
		animator.addAnimation("sign",
				AnimationBuilder.create(Assets.SHEEP_INFO, 60, 1, 1, null),
				PlayMode.NORMAL);
