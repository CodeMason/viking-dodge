...
public class SheepSpawner extends Spawner implements Spawn<Sheep> {

	public SheepSpawner(EntityHandler entityHandler, float x, float y) {
		super(entityHandler, x, y, 20);
	}

	
	@Override
	public Sheep spawn() {
		Sheep sheep = new Sheep(pos, entityHandler);
		sheep.create();
		return sheep;
	}
