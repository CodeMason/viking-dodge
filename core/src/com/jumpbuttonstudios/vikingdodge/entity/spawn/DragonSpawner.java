...
public class DragonSpawner extends Spawner implements Spawn<Dragon> {

	public DragonSpawner(EntityHandler entityHandler, float x, float y) {
		super(entityHandler, x, y, 90);
		
	}

	@Override
	public Dragon spawn() {
		return new Dragon(pos.x, entityHandler, entityHandler);
	}
